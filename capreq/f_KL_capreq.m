function diff=f_KL_capreq(XX,params)

%Calculates the steady state capital, for capital requirement model
%Output: diff: difference between the lhs and rhs of the equilibrium condition (needs to be 0)
%Input: XX: vector of capital and labor (K,L)
